...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jXPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 90, 300, 70));
        ...
        tblUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "User ID", "User NIC", "User Name", "Mobile No.", "email Address", "Address"
            }
        ));
        ...
        jXPanel1Layout.setVerticalGroup(
            jXPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jXPanel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 780, Short.MAX_VALUE)
        );
    ...
    private void getAllUser() {
        try {
            ...
            ArrayList<UserDTO> getAllUser=ManageUserController.getUser();
            if(getAllUser != null){
                for (UserDTO userDTO : getAllUser) {
                    Object[] rowData={userDTO.getUserId(),userDTO.getUserNic(),userDTO.getUserName(),userDTO.getMobile(),userDTO.getEmail(),userDTO.getUserAddress()};
                    dtm.addRow(rowData);
                }
            }
        } catch (Exception ex) {
